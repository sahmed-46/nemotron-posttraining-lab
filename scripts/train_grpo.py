#!/usr/bin/env python3
"""Run Group Relative Policy Optimization (GRPO / RLVR)."""
...
def main() -> None:
    ...
    parser.add_argument("--method-config", default="configs/grpo.yaml")
    ...
    ckpt = run_grpo(cfg, processed, model_path=args.model_path)
    print(f"GRPO checkpoint saved to {ckpt}")
